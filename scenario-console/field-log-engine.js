...
(function (global) {
  ...
  "commute-to-walk": [
    {
      "id": "walking-after-commute",
      "description": "Walking after commute corridor",
      "where": {
        "activity": "walking",
        "minWalkingScore": 10
      },
  ...
  "offer-density-ring": [
    {
      "id": "offer-density-tier",
      "description": "Offer density tier scored (v2 fixed radii)",
      "where": {
        "minOfferDensityPoints": 8
      },
      "expect": {
